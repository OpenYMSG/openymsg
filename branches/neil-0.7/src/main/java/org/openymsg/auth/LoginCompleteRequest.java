 ...
 * response (MD5Crypt'd)
 */
public class LoginCompleteRequest implements Message {
	...
	public LoginCompleteRequest(String username, String cookieY, String cookieT, String base64, String cookieB) {
