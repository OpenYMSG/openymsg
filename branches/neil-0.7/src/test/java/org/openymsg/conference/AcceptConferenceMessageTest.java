...
public class AcceptConferenceMessageTest {
	...
	public void testSingleYahoo() throws IOException {
		String test = "Magic:YMSG Version:16 Length:69 Service:CONFLOGON Status:DEFAULT SessionId:0x58fe2f  [1] [testuser] [57] [testbuddy-8iVmHcCkflGJpBXpjBbzCw--] [3] [testbuddy]";
