...
/**
 * Test method for {@link org.openymsg.legacy.roster.Roster#syncedAdd(org.openymsg.legacy.network.YahooUser)}. This testcase checks if
 * adding items to the roster persists those items on the roster.
 * 
...
public class RosterSyncedAdd {
    ...
    /**
     * Checks if adding a user to the roster doesn't throw any runtime exceptions.
     * 
     * @throws Throwable
     */
    @Test
    ...
    public void testReturnTrueAfterAddingNonExistingUser() throws Throwable {
        final Object returnValue = PrivateAccessor.invoke(roster, "syncedAdd", new Class[] { YahooUser.class },
                new Object[] { USER });
    ...
    /**
     * Checks if an iterator of the roster contains the added user on the roster.
     * 
     * @throws Throwable
     */
    @Test
