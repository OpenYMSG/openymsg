...
/**
 * Test method for {@link org.openymsg.legacy.roster.Roster#syncedRemove(String userId)}. This testcase checks if removing
 * items from the roster persists that change on the roster.
 * 
