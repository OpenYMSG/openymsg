 ...
 * the network.
 */
public class YahooGroupV1 implements YahooGroup {
	private String name;
	 ...
	 */
	public YahooGroupV1(String name, boolean isOpen) {
		this.name = name;
		this.isOpen = isOpen;
	 ...
	 *            Name of the group.
	 */
	public YahooGroupV1(String name) {
		this(name, true);
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof YahooGroupV1)) {
			return false;
		}
		final YahooGroupV1 other = (YahooGroupV1) obj;
		if (name == null) {
			if (other.name != null) {
				return false;
			}
