 ...
 * @author S.E. Morris
 */
public class YahooUserV1 implements YahooUser {
	/**
	 ...
	 */
	public YahooUserV1(final String userId, final String groupId) {
	 ...
	 *            The ID of the user.
	 */
	public YahooUserV1(final String userId) {
		this(userId, null);
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof YahooUserV1)) {
			return false;
		}
		final YahooUserV1 other = (YahooUserV1) obj;
		if (userId == null) {
