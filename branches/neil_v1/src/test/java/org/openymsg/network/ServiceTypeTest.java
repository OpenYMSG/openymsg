...
public class ServiceTypeTest {
	...
	public void testGetValue() {
		...
		for (int i = 0; i < types.length; i++) {
			final Integer serviceTypeIntValue = Integer.valueOf(types[i]
					.getValue());
			assertFalse("Non-unique ServiceType value " + types[i].getValue(),
					checkedValues.contains(serviceTypeIntValue));
