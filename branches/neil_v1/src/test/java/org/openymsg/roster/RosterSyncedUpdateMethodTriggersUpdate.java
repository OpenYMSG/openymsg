...
/**
 * Testcase to check if an 'syncedUpdate()' to a {@link Roster} triggers the
 ...
 * will check if the 'syncedUpdate' functionality actually manipulate the
 * content of the Roster.
 * 
 * @author Guus der Kinderen, guus@nimbuzz.com
 */
public abstract class RosterSyncedUpdateMethodTriggersUpdate<T extends Roster<U>, U extends YahooUser> {
	...
	public void testReceiveOnOneRegisteredListener() throws Throwable {
		...
		updateUserInRoster(roster, user);
	...
	protected abstract void updateUserInRoster(T roster, U user) throws Throwable;
