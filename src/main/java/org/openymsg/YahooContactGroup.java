...
public interface YahooContactGroup {
	...
	/**
	 * Is the group still active. False if it has been deleted. A deleted group has no contacts. If a group is created
	 * with the same name, it will be a new instance. A group will not become active after it is deleted
