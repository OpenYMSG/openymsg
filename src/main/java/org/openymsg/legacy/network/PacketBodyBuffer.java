 ...
 * sometimes just keys) with each field separated by the sequence 0xc080 Note: this class is NOT thread safe (although,
 * to be honest, building a single message body from more than one independent thread is surely asking for trouble?!??)
