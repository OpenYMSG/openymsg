...
public class YahooUser {
	 ...
	 * @param groupId The ID of the group in which this user has been put.
	 */
	 ...
	 * @param ignored <tt>true</tt> if this user is on the ignore list.
	 */
	 ...
	 * Note that setting this flag does not update the status of this User on the network. This method is used by
	 * internal library code, and should probably not be used by users of the OpenYMSG library directly.
	 * @param blocked <tt>true</tt> if this user is on our StealthBlocked list.
	 */
	 ...
	 * Note that setting this flag does not update the status of this User on the network. This method is used by
	 * internal library code, and should probably not be used by users of the OpenYMSG library directly.
	 * @param stealth The stealth mode.
	 */
	 ...
	 * internal library code, and should probably not be used by users of the OpenYMSG library directly.
	 * @param groupId The ID of the group that this user is in.
	 */
