 ...
 * MD5Crypt Originally converted by the folks at www.orangefood.com This class implements the popular MD5Crypt function
 * as used by BSD and most modern Un*x systems. It was basically converted from the C code write by Poul-Henning Kamp.
 * Here is his comment: "THE BEER-WARE LICENSE" (Revision 42): <phk@login.dknet.dk> wrote this file. As long as you
...
public final class UnixCrypt {
	...
	/**
	 * Partial implementation of Unix CRYPT. This implementation supports MD5Crypt only. (partial copy of
	 * <tt>man CRYPT(3)<tt>)
	 * 
	 ...
	 * <tt>$1$caeiHQwX$hsKqOjrFRRN6K32OWkCBf1</tt>. The whole MD5 password string is passed as setting for
	 * interpretation.
	 * @param key typically a user's typed password.
	 * @param salt The salt for this crypt, prepended by <tt>$1</tt> as this method supports MD5 hashing only.
	 * @return The Crypted representation of the 'key' argument.
	 * @throws NoSuchAlgorithmException
	 * @throws IllegalArgumentException if the 'salt' argument does not start with <tt>$1</tt> (which is the indication
	 *         that MD5 should be used).
	 */
	 ...
	 * @param key The to-be-crypted string, usually a password
	 * @param salt The salt for the crypt (without a prepending <tt>$1$</tt> string).
	...
	/**
	 * Implementation of Unix MD5Crypt.
	 * @param key The to-be-crypted byte array, usually a password representation
	 * @param salt The salt for the crypt (without a prepending <tt>$1$</tt> bytes).
	...
	public static String md5Crypt(final byte[] key, final byte[] salt) throws NoSuchAlgorithmException {
		...
		int[] anFinal =
				new int[] {(abyFinal[0] & 0x7f) | (abyFinal[0] & 0x80), (abyFinal[1] & 0x7f) | (abyFinal[1] & 0x80),
