...
public class YahooChatLobby {
	...
	/**
	 * Creates a new lobby, identified by the provided lobby number. Lobbies can have reported attributes. This happens
	 * when a listing of category/room/lobbies is retrieved, where summaries are available. Examples of attributes that
	 * are reported are the number of webcam or voice capable users inside the room.
	 * @param parentRoomName The name of the room in which this lobby is being created.
	 * @param parentRoomId The id of the room that this lobby belongs to.
	 * @param lobbyNumber The number of this lobby.
	 */
	 ...
	 * @param yahooChatUser The user to add to this lobby.
	 */
	 ...
	 * @param yahooChatUser The user to remove from this lobby.
	 */
	 ...
	 * @param yahooChatUser The user for which to check this lobby.
	 ...
	 * attributes that are reported are the number of webcam or voice capable users inside the room. Note that these
	 * values represent a state view at the time the listing was refresh last. For more accurate values, try iterating
	 * over all users in a room.
	 ...
	 * @param reportedUsers The number of users that should be in this lobby, as reported by the Yahoo directory
	 *        listing.
	 */
	 ...
	 * @param reportedVoices The number of voice-capable users that should be in this lobby, as reported by the Yahoo
	 *        directory listing.
	 */
	 ...
	 * @param reportedWebcams The number of webcam-capable users that should be in this lobby, as reported by the Yahoo
	 *        directory listing.
	 */
