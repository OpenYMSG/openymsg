 ...
 * multiple independent chat spaces, known as 'lobbies'. Rooms are placed into a hierarchy structure of named
 * categories. *
...
public class YahooChatRoom {
	 ...
	 * @param lobby The lobby to add to this room.
	 */
	 ...
	 * @param lobby The lobby to search for in this room.
