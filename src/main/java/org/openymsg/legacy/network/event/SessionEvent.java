...
/**
 * This class is the parent of all event classes in this package. To From Message Timestamp contactRejectionReceived y y
 * y n contactRequestReceived y y y y messageReceived y y y n buzzReceived y y y n offlineMessageReceived y y y y
 * listReceived n n n n logoffReceived n n n n
...
public class SessionEvent extends java.util.EventObject {
	...
	public String toString() {
		StringBuffer sb = new StringBuffer(getClass().getCanonicalName()).append(" to:").append(to).append(" from:")
				.append(from).append(" message:").append(message).append(" timestamp:").append(timestamp)
