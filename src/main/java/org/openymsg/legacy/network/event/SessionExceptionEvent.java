...
/**
 * This class is used to pass exceptions from the input thread to the main application. Message Exception
...
public class SessionExceptionEvent extends SessionEvent {
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("Exception: message=\"").append(message).append("\" type=")
