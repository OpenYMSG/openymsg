...
import org.openymsg.legacy.network.StatusConstants;

/**
 * This event is used to convey Yahoo notification events, like typing on/off from other Yahoo users we're communicating
 * with. Notification events contain two major identifiers: a 'type', that denotes the type of event for which a
 * notification is sent, and a 'mode', which tells us if the activity has started or ended.
...
public class SessionNotifyEvent extends SessionEvent {
	 ...
	 * @param source {@link SessionEvent#getSource()}
	 * @param to {@link SessionEvent#getTo()}
	 * @param from {@link SessionEvent#getFrom()}
	 * @param message May contain the game name for some types of notifications.
	 * @param type The type of the notification
	 * @param mode boolean value that tells us if this is an ON or OFF notification.
	 */
	 ...
	 * @throws IllegalStateException If the type of this notification does not equal the type for gaming.
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.openymsg.legacy.network.event.SessionEvent#toString()
	 */
	@Override
	public String toString() {
		StringBuffer sb = new StringBuffer(super.toString()).append(" type:").append(type).append(" mode:")
				.append((mode ? "1" : "0"));
		return sb.toString();
	}
}
