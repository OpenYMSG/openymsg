...
public class CollectionUtils {
	 ...
	 * @param key The key for which to remove a value.
	 * @param value The value for which to remove the key.
	 * @param map The object that maps the key to a set of values, on which the operation should occur.
	 */
