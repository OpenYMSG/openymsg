 ...
 * Yahoo, and translating them into something a bit more Java-friendly. Currently the decoder can translate messages
 * into plain text only (formatting stripped).
