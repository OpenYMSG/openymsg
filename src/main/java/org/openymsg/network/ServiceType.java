...
/**
 * Enumeration of all ServiceType values, as found in the YMSG packets. These sould match the names in WireShark.
...
public enum ServiceType {
	 ...
	 * enum value exists.
	 * @param value Integer value representing a ServiceType
