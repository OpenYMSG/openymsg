...
public class RosterEvent extends EventObject {
	...
	/**
	 * Creates a new RosterEvent instance, based on the {@link Roster} object
	 * that is the source of this event, a reference to the user on the Roster
	 * object that caused the change and the type of change that was made.
	 * 
	 * @param user
	 * @param type
	 * @param source
	...
	public String toString() {
		return getClass().getName() + "[type=" + type + ", user=" + user
				+ ", source=" + source + "]";
	}
}
