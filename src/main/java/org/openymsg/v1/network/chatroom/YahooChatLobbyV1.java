...
public class YahooChatLobbyV1 implements YahooChatLobby<YahooChatUserV1> {
	 ...
	 * 
	 * Lobbies can have reported attributes. This happens when a listing of
	 * category/room/lobbies is retrieved, where summaries are available.
	 * Examples of attributes that are reported are the number of webcam or
	 * voice capable users inside the room.
	 * 
	 ...
	 * 
	 * @param reportedUsers
	 *            The number of users that should be in this lobby, as reported
	 *            by the Yahoo directory listing.
	 */
	 ...
	 *            The number of voice-capable users that should be in this
	 *            lobby, as reported by the Yahoo directory listing.
	 */
	 ...
	 *            The number of webcam-capable users that should be in this
	 *            lobby, as reported by the Yahoo directory listing.
	 */
