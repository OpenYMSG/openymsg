...
public class ConferenceInviteResponseTest {
	...
	public void testSingleInviteYahoo() throws IOException {
		String test =
				"Magic:YMSG Version:16 Length:208 Service:CONFINVITE Status:SERVER_ACK SessionId:0x58fe2f  [1] [testuser] [13] [0] [50] [testbuddy] [52] [testuser] [57] [testbuddy-8iVmHcCkflGJpBXpjBbzCw--] [58] [Invitingtestuser] [97] [1] [233] [grFkPBIo9ofg.TLbOmEWP2ceP3iZMlbEY-] [234] [testbuddy-8iVmHcCkflGJpBXpjBbzCw--]";
	...
	public void testSingleInviteAckYahoo() throws IOException {
		String test =
				"Magic:YMSG Version:16 Length:208 Service:CONFINVITE Status:SERVER_ACK SessionId:0x58fe2f  [1] [testuser] [13] [0] [50] [testuser] [52] [testbuddy] [57] [testuser-8iVmHcCkflGJpBXpjBbzCw--] [58] [Invitingtestbuddy] [97] [1] [233] [grFkPBIo9ofg.TLbOmEWP2ceP3iZMlbEY-] [234] [testuser-8iVmHcCkflGJpBXpjBbzCw--]";
		YMSG9Packet packet = PacketReader.readString(test);
		ConferenceInviteResponse response = new ConferenceInviteResponse(session);
		response.execute(packet);
