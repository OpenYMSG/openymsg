...
public class ConferenceLeaveResponseTest {
	...
	public void testLogoffMultipleMembersYahoo() throws IOException {
		String test =
				"Magic:YMSG Version:16 Length:118 Service:CONFLOGOFF Status:SERVER_ACK SessionId:0x56cf6d  [1] [testuser] [302] [3] [3] [testuser] [3] [testbuddy] [303] [3] [56] [testbuddy2] [57] [testuser-8iVmHcCkflGJpBXpjBbzCw--]";
	...
	public void test() throws IOException {
		String test =
				"Magic:YMSG Version:16 Length:161 Service:CONFLOGOFF Status:SERVER_ACK SessionId:0x58fe2f  [1] [testuser] [302] [3] [3] [testuser] [3] [testbuddy] [3] [testbuddy2] [3] [testbuddy3] [3] [testbuddy4] [303] [3] [56] [testbuddy5] [57] [testuser-8iVmHcCkflGJpBXpjBbzCw--]";
		YMSG9Packet packet = PacketReader.readString(test);
		ConferenceLeaveResponse response = new ConferenceLeaveResponse(session);
		response.execute(packet);
		String id = "testuser-8iVmHcCkflGJpBXpjBbzCw--";
