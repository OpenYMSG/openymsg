...
public class CreateConferenceMessageTest {
	...
	public void testSingleYahoo() throws IOException {
		String test = "Magic:YMSG Version:16 Length:124 Service:CONFINVITE Status:DEFAULT SessionId:0x56cf6d  [1] [testuser] [50] [testuser] [57] [testuser-8iVmHcCkflGJpBXpjBbzCw--] [58] [Invitingtestbuddy] [97] [1] [52] [testbuddy] [13] [0]";
