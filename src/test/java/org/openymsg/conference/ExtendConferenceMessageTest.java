...
public class ExtendConferenceMessageTest {
	...
	public void test() throws IOException {
		String test = "Magic:YMSG Version:16 Length:220 Service:CONFADDINVITE Status:DEFAULT SessionId:0x56cf6d  [1] [testuser] [57] [testuser-8iVmHcCkflGJpBXpjBbzCw--] [51] [testbuddy2] [53] [testbuddy] [58] [joinconference] [97] [1] [13] [0] [234] [testuser-8iVmHcCkflGJpBXpjBbzCw--] [233] [grFkPBBAjXW0JFb50yovkfmdm567JexLc-]";
		...
		ExtendConferenceMessage outgoing = new ExtendConferenceMessage(username, conference, membership,
				invitedContacts, message);
		MessageAssert.assertEquals(outgoing, test, "233", "234");
	}

	@Test
	public void testMutlipleInvitesMultipleMembers() throws IOException {
		String test = "Magic:YMSG Version:16 Length:247 Service:CONFADDINVITE Status:DEFAULT SessionId:0x58fe2f  [1] [testuser] [57] [testuser-8iVmHcCkflGJpBXpjBbzCw--] [51] [testbuddy3,testbuddy4,testbuddy5] [53] [testbuddy] [53] [testbuddy2] [58] [joinconference] [97] [1] [13] [0] [234] [testuser-8iVmHcCkflGJpBXpjBbzCw--] [233] [grFkPBIo9ofg.TLbOmEWP2ceP3iZMlbEY-]";
		String username = "testuser";
	...
	public void testMultipleOutstandingInvites() throws IOException {
		String test = "Magic:YMSG Version:16 Length:257 Service:CONFADDINVITE Status:DEFAULT SessionId:0x56cf6d  [1] [testuser] [57] [testuser-8iVmHcCkflGJpBXpjBbzCw--] [51] [testbuddy] [53] [testbuddy2] [52] [testbuddy3] [52] [testbuddy4] [52] [testbuddy5] [58] [joinconference] [97] [1] [13] [0] [234] [testuser-8iVmHcCkflGJpBXpjBbzCw--] [233] [grFkPBBAjXW0JFb50yovkfmdm567JexLc-]";
		String username = "testuser";
