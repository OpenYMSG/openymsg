...
public class ListOfContactsResponseTest {
	...
	public void testSimple() {
		...
		ListOfContactsResponse response = new ListOfContactsResponse(sessionContact, sessionGroup, statusCallback);
		...
		verify(statusCallback).addedPending(this.getPendingContacts());
