...
/**
 * Checks for {@link Roster#remove(org.openymsg.legacy.network.YahooUser)}, calling which should result into outgoing packets
 * to the yahoo network, indicating that you want to add a contact from your roster.
 * 
