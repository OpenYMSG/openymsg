...
/**
 * Testcase to check if an 'syncedUpdate()' to a {@link Roster} triggers the expected Event to be broadcasted to all
 * listeners.
 * <p>
 * Note that this method checks the event listener routines only. Other methods will check if the 'syncedUpdate'
