...
public class MessageResponseTest {
	...
	public void testSimple() {
		String test =
				"Magic:YMSG Version:16 Length:206 Service:MESSAGE Status:SERVER_ACK SessionId:0x5fcd19  [4] [testbuddy] [5] [testuser] [14] [sending message] [15] [1335299986] [63] [;0] [64] [0] [97] [1] [206] [2] [252] [GHXzmtBef5EjXVljxP9GLk4WZBJnlQ==] [429] [000000004172116E] [450] [0] [455] [GHXzmtBef5EjXVljxP9GLk4WZBJnlQ==]";
		YMSG9Packet packet = PacketReader.readString(test);
		SessionMessageImpl session = new SessionMessageImpl(connection, username, callback);
	...
	public void testProcotol() {
		String test =
				"Magic:YMSG Version:16 Length:158 Service:MESSAGE Status:SERVER_ACK SessionId:0x45130f  [4] [testbuddy@live.com] [5] [testuser] [14] [hello back] [15] [1332786061] [241] [2] [252] [Ihq8NfPGNq9SBqI9cXsa+Wh2T5/Izw==] [455] [Ihq8NfPGNq9SBqI9cXsa+Wh2T5/Izw==]";
		YMSG9Packet packet = PacketReader.readString(test);
		SessionMessageImpl session = new SessionMessageImpl(connection, username, callback);
		MessageResponse response = new MessageResponse(session);
		response.execute(packet);
