...
public class RosterEventTest {
     ...
     * {@link org.openymsg.legacy.roster.RosterEvent#RosterEvent(org.openymsg.legacy.roster.Roster, org.openymsg.legacy.network.YahooUser, org.openymsg.legacy.roster.RosterEventType)}
     * .
     */
    ...
    /**
     * Test method for {@link org.openymsg.legacy.roster.RosterEvent#getUser()}.
     */
    @Test
    public void testGetUser() {
        ...
        for (final RosterEventType type : RosterEventType.values()) {
            assertEquals("failed on type=" + type, user, new RosterEvent(new Roster(new MockFriendManager()), user,
                    type).getUser());
        }
    }

    /**
     * Test method for {@link org.openymsg.legacy.roster.RosterEvent#getType()}.
     */
    @Test
    public void testGetType() {
        for (final RosterEventType type : RosterEventType.values()) {
            assertEquals(type, new RosterEvent(new Roster(new MockFriendManager()), new YahooUser("dummy"), type)
                    .getType());
        }
    }

    /**
     * Test method for {@link org.openymsg.legacy.roster.RosterEvent#getSource()}.
     */
    @Test
