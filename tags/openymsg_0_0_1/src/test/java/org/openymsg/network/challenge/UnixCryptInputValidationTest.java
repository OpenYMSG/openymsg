...
public class UnixCryptInputValidationTest {
	...
	/**
	 * Argument validation for Crypt(). The argument 'key' cannot be an empty
	 * String.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Argument validation for Crypt(). The argument 'salt' cannot be an empty
	 * String.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Currently, only MD5 crypt is supported. Attempting BlowFishCrypt should
	 * throw an exception Test method for
	 * {@link org.openymsg.network.challenge.UnixCrypt#crypt(java.lang.String, java.lang.String)}.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Currently, only MD5 crypt is supported. Attempting Extended Crypt should
	 * throw an exception Test method for
	 * {@link org.openymsg.network.challenge.UnixCrypt#crypt(java.lang.String, java.lang.String)}.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Currently, only MD5 crypt is supported. Attempting MD5 Crypt should NOT
	 * throw an exception Test method for
	 * {@link org.openymsg.network.challenge.UnixCrypt#crypt(java.lang.String, java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Currently, only MD5 crypt is supported. Attempting Crypt without a
	 * recognized method in the salt should throw an exception Test method for
	 * {@link org.openymsg.network.challenge.UnixCrypt#crypt(java.lang.String, java.lang.String)}.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Currently, only MD5 crypt is supported. Attempting Crypt without a method
	 * in the salt should throw an exception Test method for
	 * {@link org.openymsg.network.challenge.UnixCrypt#crypt(java.lang.String, java.lang.String)}.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Attempting Crypt without a salt Stripped from its method should throw an
