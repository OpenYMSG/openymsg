...
public enum AuthenticationState {
	...
	/**
	 * Returns the AuthenticationState that is identified by the provided long
	 * value. This method throws an IllegalArgumentException if no matching
	 * AuthenticationState is defined in this enumeration.
	 * 
	 * @param value
	...
	public static AuthenticationState getStatus(long value) {
		...
		throw new IllegalArgumentException(
				"No AuthenticationState matching long value '" + value + "'.");
	}
}
