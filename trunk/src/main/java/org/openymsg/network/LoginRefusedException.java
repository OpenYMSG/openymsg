...
/**
 * Represents an exception that indicates a problem during logging into the
 * Yahoo network. An optional status may be supplied, which can contain more
 * information as to the cause of the faillure.
 * 
...
public class LoginRefusedException extends YahooException {
	...
	/**
	 * Returns the status associated with this problem, or -1 if no status was
	 * set.
	 * 
	 * @return Status
	 */
